...
SECRET_KEY = 'django-insecure-s0fm%ym5(795cs#m4sw87t3q7m*b5c$$%sgz*^3=&35*5%kf+#'
...
DATABASES = {
    ...
    'NAME': 'laundry', # Nama database yang telah dibuat di phpMyAdmin
